...
export function generateSEOMetadata(locale: Locale): Metadata {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'ar': 'https://alfatoora.io/ar',
        'en': 'https://alfatoora.io/en',
        'es': 'https://alfatoora.io/es',
        'fr': 'https://alfatoora.io/fr',
        'zh': 'https://alfatoora.io/zh',
        'ru': 'https://alfatoora.io/ru',
        'hi': 'https://alfatoora.io/hi',
        'it': 'https://alfatoora.io/it',
        'pt': 'https://alfatoora.io/pt',
        'ur': 'https://alfatoora.io/ur',
        'tr': 'https://alfatoora.io/tr',
        'sw': 'https://alfatoora.io/sw',
        'x-default': 'https://alfatoora.io/en',
      },
    },
    robots: {
      index: true,
...
export function generateSoftwareAppSchema(locale: Locale) {
  ...
  return {
    ...
    screenshot: 'https://alfatoora.io/screenshot.png',
    softwareVersion: '2.0',
    releaseNotes: 'Multi-language support with 12 languages',
  }
}
